...
**4. Safe References:**
- `try(jsondecode(...).properties.singlePlacementGroup, null)` safely handles missing property
- Null check on `data.azapi_resource.existing.output` before access
...
✅ **Edge Cases:** All edge cases properly analyzed and handled:
  ...
  - State comparison using data.azapi_resource.existing
...
No deviations, simplifications, or "safer alternatives" were found. The implementation provides EXACT behavior match with the AzureRM provider.
